...
import eval_util, eval_constants
...
def preprocess(inf,species,is_mmod):
    ...
    if True:
        chebi_loaded_model = ChebiLoadedModel([doc_chebi.getModel(), doc.getModel()])
    ...
    go1=compute_chebi_distance(inf,species,'mf',not is_mmod,True,S,mets,rxns,revs,chebi_loaded_model)
    return go1
...
if __name__ == '__main__':
    ...
    preprocess('/Users/fatemeh/Documents/comparison_1/RESULTS/ecoli_core/Ding/final_modules.txt','ecoli_core',True)