...
import importer
import my_util
from my_util import write_line
import eval_util
...
def preprocess(inf,species,is_mmod):
    ...
    mo=compute_cohesion_coupling(inf,is_mmod,True,S,mets,rxns,revs)
    return mo
def mat_rows(l, lj=0):
    m = l[0]
    if lj > 0:
...
if __name__ == '__main__':
    ...
    preprocess('/Users/fatemeh/Documents/comparison_1/RESULTS/ecoli_core/poolman/final_modules_0.5.txt','ecoli_core',False)