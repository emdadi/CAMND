...
alpha = 1.0
def preprocess(inf,is_mmod):
    eff=compute_efficacy(inf,not is_mmod,True)
    return eff
...
def compute_efficacy(inf, is_rmod, is_partial_module):
    if is_rmod:
...
if __name__ == '__main__':
    ...
    preprocess('/Users/fatemeh/Documents/comparison_1/RESULTS/ecoli_core/poolman/final_modules_0.5.txt',False)
    #print compute_efficacy(,True,True)